      ...
      <ReactReduxContext.Consumer>
        {reactReduxContext => (
          <DynamicModuleLoaderImpl
            {...this.props}
            reactReduxContext={reactReduxContext as unknown as { store: IModuleStore<any> }}
          />
        )}
      </ReactReduxContext.Consumer>
    );
...
> {
  ...
  private _providerInitializationNeeded = false;
  ...
  constructor(props: IDynamicModuleLoaderImplProps) {
    ...
    if (props.reactReduxContext == null) {
      const message = 'Tried to render DynamicModuleLoader, but no ReactReduxContext was provided';
      console.error(message);

      throw new Error(message);
    }

    this._store = props.reactReduxContext ? props.reactReduxContext.store : undefined;
  ...
  public render(): React.ReactNode {
    if (this.state.readyToRender) {
      if (this._providerInitializationNeeded && this._store) {
        return (
